...
import { Calendar, CheckCircle, Clock, IndianRupee, MapPin, MessageSquare, Phone, Users, Check, CarIcon } from 'lucide-react';
            ...
            <CardContent className="space-y-4 text-muted-foreground">
              ...
              {driver.vehicle && (
                <div className="flex items-center space-x-3">
                    ...
                    <span>Vehicle: <span className="font-medium text-foreground">{driver.vehicle}</span></span>
                </div>
              )}
            </CardContent>
          </Card>
